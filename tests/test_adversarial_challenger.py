...
class TestAdversarialChallenger(unittest.TestCase):
    ...
    def test_vram_factor_crashes_on_none_base_kv(self):
        ...
        try:
            val = estimate_vram_mb(
                Path("non-existent"), 2048, kv_cache_k=None, kv_cache_v=None, base_kv_cache=None
            )
            crashed = False
    ...
    def test_run_evaluation_dict_non_string_keys(self, _mock_free, mock_coding, mock_runner):
        ...
        cfg = {123: "numeric-key-value", None: "none-key-value", "model": "model-from-dict.gguf"}
        res = run_evaluation(cfg, skip_bench=True, include_coding=False)
        intent = mock_runner.call_args[0][0]
    ...
    def test_run_evaluation_none_config(self, _mock_free, mock_coding, mock_runner):
        ...
        res = run_evaluation(
            None, skip_bench=True, model="fallback-override.gguf", include_coding=False
        )
        intent = mock_runner.call_args[0][0]
    ...
    def test_run_evaluation_list_config(self, _mock_free, mock_coding, mock_runner):
        ...
        res = run_evaluation(
            ["some", "list"], skip_bench=True, model="list-override.gguf", include_coding=False
        )
        intent = mock_runner.call_args[0][0]
    ...
    def test_run_evaluation_bad_dict_class(self, _mock_free, mock_coding, mock_runner):
        ...
        cfg = BadDictClass()
        res = run_evaluation(
            cfg, skip_bench=True, model="bad-dict-override.gguf", include_coding=False
        )
        intent = mock_runner.call_args[0][0]
    ...
    def test_run_evaluation_bad_dir_class(self, _mock_free, mock_coding, mock_runner):
        ...
        cfg = BadDirClass()
        res = run_evaluation(
            cfg, skip_bench=True, model="bad-dir-override.gguf", include_coding=False
        )
        intent = mock_runner.call_args[0][0]
