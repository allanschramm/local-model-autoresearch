...
## Purpose
Course materials to teach anyone to run local AI from scratch. Módulo 0, Semana 1 (incl. Dia 4 skills), and Semana 2 · Dias 1–2 (samplers + MCP/Context7) are published; Semana 2 Dias 3–4 remain curriculum drafts.
...
- Semana 2 · Dias 1–2 published (sampling / `SAMPLER_DEFAULTS`; MCP + Context7). Dias 3–4 stay “Em construção”, outside progress until published. Skills stay in S1D4 — S2D2 is MCP-only.
