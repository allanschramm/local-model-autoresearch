...
- **whichllm / llmfit are candidates only**: Not final fit authority — especially on `unified_memory`, where they may treat RAM as full “VRAM” and rank oversized models. Local `check_hardware` + conservative headroom win; discard unsafe #1 picks and explain why.
