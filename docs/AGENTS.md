...
- [docs/adr/AGENTS.md](adr/AGENTS.md) — architecture decision records contract + index (ADRs 0001–0008).
...
- [docs/agents/](agents/) — Engineering-skills config: issue tracker, triage labels, domain-doc consumer rules.
