...
## Origem
Session captured 2 `whichllm plan` + 1 `whichllm --speed usable`. Outputs verbatim abaixo.

## Output 3: `whichllm plan "qwen 3.6 35b"`

```
user@host:~$ whichllm plan "qwen 3.6 35b"
...
```
user@host:~$ whichllm plan 'qwen3.5 9b'
...
- [ ] Optional: re-Trial Qwen3.5-9B MTP recipe (historical Autoloop 134-272 TPS)
