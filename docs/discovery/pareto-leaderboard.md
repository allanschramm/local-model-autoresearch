...
| :--- | :--- | :--- |
| **Night** | `CTX ≥ 65536` then max `min(agentic, coding)` | **POCKET-35B-Q3_K_M** (min **0.615**) |
...
| 2 | `Ornith-1.0-9B-UD-Q4_K_XL.gguf` | 65k* | 42.1 | 0.6000 | 0.5700 | 0.5700 | *ag@65k / cod@32k merge |
| 3 | `Ornith-1.0-35B-UD-Q4_K_XL.gguf` | 65k | 25.7 | 0.6000 | 0.5800 | 0.5800 | [2026-07-27](../sessions/2026-07-27-incomplete-vectors-pareto.md) |
...
| 6 | `Qwythos-9B-Claude-Mythos-5-1M-Q4_K_M.gguf` | 131k | 43.6 | 0.3333 | 0.6400 | 0.3333 | coding king |
...
| 11 | `LFM2.5-8B-A1B-Q4_K_M.gguf` | 65k | 178.5 | 0.2000 | 0.3650 | 0.2000 | max TPS; not Day pick |
| 12 | `Laguna-XS-2.1-Q3_K_XL.gguf` | 65k | 37.2 | 0.6667 | 0.1950 | 0.1950 | agentic top; coding weak |

Exact domination membership can shift when TPS sources differ (claw vs coding Combined TPS). Treat the table as the teaching front; recompute from `results.tsv` before deleting GGUFs.

## `dominated` (complete, someone covers)

Examples: `Bonsai-27B-Q1_0`, `Qwen3.6-35B-A3B-UD-Q3_K_XL`, Mythos-MTP, `nanbeige4.2-3b`, `POCKET-26B` (deleted).

## `incomplete` / rejected

| Model | Gap | Status |
| :--- | :--- | :--- |
| `Qwen3.5-9B-UD-Q4_K_XL.gguf` | coding | **Rejected** — VRAM kill @ 32k+MTP and 65k no MTP mid coding-10. SSD delete candidate. |
...
| Job | Prefer |
| :--- | :--- |
| Night / long agent loops | **POCKET-35B** |
| Day / supervised (ADR 0008) | **Ornith-9B-MTP** (or Ornith-9B-UD if `DAY_IQ_RATIO=0.8`) |
| Direct coding | Mythos → POCKET-35B → Ornith-9B / Ornith-35B-Q4 |
...
* Session: [2026-07-27 incomplete vectors + Pareto](../sessions/2026-07-27-incomplete-vectors-pareto.md)
