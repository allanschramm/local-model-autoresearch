...
| 2 | `ornith-1.0-9b-Q4_K_M` (legacy) | **0.5800** | 0.40 | 0.80 | 0.90 | 0.10 | 131k | Older filename/quant |
| 3 | `Ornith-1.0-9B-UD-Q4_K_XL` | **0.5700** | 0.40 | 0.90 | 0.70 | 0.20 | **32k** | Alias `ornith-9b`; LCB patched† |
| 4 | `gemma-4-12B-it-qat-UD-Q4_K_XL` | **0.5650** | 0.40 | 0.80 | 0.90 | 0.00 | 131k | Historical KEEP |
| 5 | `LFM2.5-1.2B-Instruct-Q8_0` | **0.3500** | 0.10 | 0.50 | 0.70 | 0.10 | 65k f16 | LCB patched† |
| 6 | `Laguna-XS-2.1-Q3_K_XL` | **0.1950** | 0.20 | 0.20 | 0.30 | 0.00 | 65k | Best claw-full; weak coding |
...
| Job | Prefer |
| :--- | :--- |
| Agentic / tools | `laguna-xs` → `lfm2.5-1.2b` / `ornith-9b` |
| Direct coding preflight | Mythos (if GGUF present) → `ornith-9b` @ ≤32k → LFM only if need speed |
