...
1. **ngram-cache as Search neighbor** — engine-only, 0 MB VRAM, universal. Measured 2026-09-07 (Trial 0593e117, Issue #57) on Qwen3.8-4B-Distill Q4_K_M @ 131k: TPS -23.5% (72.1 vs 94.2), coding 0.5900 vs 0.6400, continuous host RAM growth (~160MB/req). Discarded on fast dense GPU models against `--spec-type none`.
...
- **Resolved (2026-09-07):** ngram gain on coding-10 — measured (Issue #57, Trial 0593e117); speedup is negative on fast dense targets (-23.5% TPS) due to low draft acceptance (1.7-9.5%) and verification pass overhead, along with continuous host RAM growth.
